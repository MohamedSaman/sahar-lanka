<div class="container-fluid py-6 bg-gray-50 min-vh-100 transition-colors duration-300">
                ...
                <div class="card-body p-5">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @forelse($duePayments as $item)
                                <tr
                                    class="border-bottom transition-all hover:bg-[#f1f5f9] {{ $loop->iteration % 2 == 0 ? 'bg-[#f9fafb]' : '' }} {{ now()->gt($item->due_date) && $item->status === null ? 'bg-danger bg-opacity-10' : '' }}">
                                    <td class="ps-4" data-label="Invoice">
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-0 text-sm fw-semibold text-gray-800">{{
                                                $item->sale->invoice_number }}</h6>
                                            <p class="text-xs text-gray-600 mb-0">{{
                                                $item->sale->created_at->format('d M Y') }}</p>
                                        </div>
                                    </td>
    ...
    <span class="text-primary fw-bold">
        {{ substr($item->sale?->customer?->name ?? 'N', 0, 1) }}
    </span>
</div>
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600 mb-0">{{ $item->sale?->customer?->phone ?? '' }}
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center" data-label="Status">
                                        ...
                                        <span class="badge bg-warning bg-opacity-10 text-warning rounded-full px-3 py-1"
                                            style="font-size: 0.75rem;">Pending Approval</span>
                                        ...
                                        <span
                                            ...
                                            style="font-size: 0.75rem;">Unknown</span>
                                        @endif
                                    </td>
                                    <td class="text-center" data-label="Actions">
                                        ...
                                        <button
                                            ...
                                            wire:click="getPaymentDetails({{ $item->id }}, {{ $item->is_payment ? 'true' : 'false' }})">
